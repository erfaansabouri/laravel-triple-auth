                        ...
                        <div class="uk-card-body uk-border-circle">
                            <div class="uk-text-center uk-margin">
                                <h6 class="uk-text-danger uk-h6">
                                    {{ Auth::guard('student')->user()->fname }} عزیز به منظور حفظ امنیت اطلاعات شما ، لازم است در اولین ورود خود به سامانه رمز عبور خود را تغییر دهید.
                                </h6>
                            </div>
                            <form class="toggle-class" action="{{ route('student.replace.password') }}" method="post" style="direction: ltr">
                                @csrf
