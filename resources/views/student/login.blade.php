            ...
            <div class="uk-grid  uk-flex-middle">
                <div class="uk-width-1-2@s uk-align-center">
                    ...
                    <div class="uk-text-center uk-margin">
                        <h2 class="chartasan-text-white uk-h2">ورود دانشجویان</h2>
                    </div>
                    <div class="uk-card chartasan-bg-dark">
                        <div class="uk-card-body uk-border-circle">
                            ...
                            <form class="toggle-class" action="{{ route('student.login.submit') }}" method="post" style="direction: ltr">
                                @csrf
                                <div class="uk-margin-small">
                                    <div class="uk-inline uk-width-1-1">
                                        <span class="uk-form-icon uk-form-icon-flip" data-uk-icon="icon: user"></span>
                                        <input class="uk-input uk-border-rounded" required placeholder="شماره دانشجویی" type="text" name="student_code" value="{{ old('student_code') }}">
                                    </div>
                                </div>
                                <div class="uk-margin-small">
                                    <div class="uk-inline uk-width-1-1">
